...
struct npu_profile_tile_record {
    ...
    bool activation_already_in_spm = false;
    bool weight_already_in_spm = false;
    uint32_t mvin_mask = 0;
    int32_t w_bank = -1;
    int32_t a_bank = -1;
    int32_t o_bank = -1;
    bool w_prefetch_issued = false;
    bool w_prefetch_hit = false;
    bool a_prefetch_issued = false;
    bool a_prefetch_hit = false;
    bool o_mvout_async = false;
    ...
    double act_cma_copy_cpu_us = 0.0;
    double act_cma_copy_dma_us = 0.0;
    double act_cma_copy_hidden_candidate_us = 0.0;
    ...
    double w_prefetch_wait_us = 0.0;
    double a_prefetch_wait_us = 0.0;
    double o_mvout_wait_us = 0.0;
    double o_mvout_hidden_candidate_us = 0.0;
    double gemm_us = 0.0;
...
struct npu_profile_node_record {
    ...
    bool full_pingpong_enabled = false;
    bool a_prefetch_enabled = false;
    bool o_overlap_enabled = false;
    ...
    int64_t act_cma_copy_cpu_calls = 0;
    int64_t act_cma_copy_dma_calls = 0;
    ...
    int64_t spm_activation_reuse_hits = 0;
    int64_t spm_weight_reuse_hits = 0;
    int64_t gemm_calls = 0;
    int64_t gemm_plan_calls = 0;
    int64_t dma_out_calls = 0;
    int64_t postprocess_calls = 0;
    int64_t raw_acc_mvout_nodes = 0;
    int64_t raw_acc_mvout_tiles = 0;
    int64_t w_prefetch_calls = 0;
    int64_t w_prefetch_hits = 0;
    int64_t w_prefetch_conflicts = 0;
    int64_t a_prefetch_calls = 0;
    int64_t a_prefetch_hits = 0;
    int64_t a_prefetch_conflicts = 0;
    int64_t o_mvout_async_calls = 0;
    int64_t packed_activation_bytes_total = 0;
    int64_t copied_weight_bytes_total = 0;
    int64_t dma_in_activation_bytes_total = 0;
    int64_t dma_in_weight_bytes_total = 0;
    ...
    double act_cma_copy_cpu_us_total = 0.0;
    double act_cma_copy_dma_us_total = 0.0;
    double act_cma_copy_hidden_candidate_us_total = 0.0;
    ...
    double w_prefetch_wait_us_total = 0.0;
    double w_prefetch_hidden_candidate_us_total = 0.0;
    double a_prefetch_wait_us_total = 0.0;
    double a_prefetch_hidden_candidate_us_total = 0.0;
    double o_mvout_wait_us_total = 0.0;
    double o_mvout_hidden_candidate_us_total = 0.0;
...
struct npu_profile_summary_delta {
    ...
    int64_t w_prefetch_hits = 0;
    int64_t w_prefetch_conflicts = 0;
    int64_t full_pingpong_nodes = 0;
    int64_t a_prefetch_enabled_nodes = 0;
    int64_t o_overlap_enabled_nodes = 0;
    int64_t full_output_cma_nodes = 0;
    int64_t a_prefetch_calls = 0;
    int64_t a_prefetch_hits = 0;
    int64_t a_prefetch_conflicts = 0;
    int64_t o_mvout_async_calls = 0;
    ...
    int64_t act_cma_copy_cpu_us_total = 0;
    int64_t act_cma_copy_dma_us_total = 0;
    int64_t act_cma_copy_hidden_candidate_us_total = 0;
    ...
    int64_t w_prefetch_wait_us_total = 0;
    int64_t w_prefetch_hidden_candidate_us_total = 0;
    int64_t a_prefetch_wait_us_total = 0;
    int64_t a_prefetch_hidden_candidate_us_total = 0;
    int64_t o_mvout_wait_us_total = 0;
    int64_t o_mvout_hidden_candidate_us_total = 0;
